    ...
    var t = function() {
      ...
      F = function(e) {
        ...
        return e.oProtocolInc.getPortInfo(e, {
          async: !1,
          success: function(e) {
            for (var o = s.$XML(e).find("AdminAccessProtocol", !0), i = 0, a = o.length; a > i; i++)"rtsp" === s.$XML(o).eq(i).find("protocol").eq(0).text().toLowerCase() && (t = parseInt(s.$XML(o).eq(i).find("portNo").eq(0).text(), 10)),
      ...
      U = function(e) {
        ...
        return e.oProtocolInc.getUPnPPortStatus(e, {
          async: !1,
          success: function(e) {
            for (var o = s.$XML(e).find("portStatus", !0), i = 0, a = o.length; a > i; i++)"rtsp" == s.$XML(o).eq(i).find("internalPort").eq(0).text().toLowerCase() && (t = parseInt(s.$XML(o).eq(i).find("externalPort").eq(0).text(), 10)),
      ...
      this.I_WriteOBJECT_XHTML = function() {
        ...
        null == c && null == c.object ? -1 : (I.browser().msie && (c.attachEvent("GetSelectWndInfo", GetSelectWndInfo), c.attachEvent("ZoomInfoCallback", ZoomInfoCallback), c.attachEvent("GetHttpInfo", GetHttpInfo), c.attachEvent("PluginEventHandler", PluginEventHandler)), E(), 0)
      },
      ...
      var Y = function(e, t, s, n, r, o, i) {
        ...
        I.extend(a, {
          success: function(a) {
            var c = new J;
            c.szIP = e,
            2 == t ? (c.szHttpProtocol = "https://", c.iHttpsPort = s) : (c.szHttpProtocol = "http://", c.iHttpPort = s),
            c.iCGIPort = s,
            c.szAuth = n,
            c.iDeviceProtocol = r,
            c.oProtocolInc = o,
      ...
      this.I_DisableEZoom = function(e) {
        ...
        if ( - 1 != t) {
          var n = p[t];
          if (n.bEZoom) return c.HWP_DisableZoom(e),
          n.bEZoom = !1,
          0
        }
        return s
      ...
      this.I_Disable3DZoom = function(e) {
        ...
        if ( - 1 != t) {
          var n = p[t];
          if (n.b3DZoom) return c.HWP_DisableZoom(e),
          n.b3DZoom = !1,
          0
        }
        return s
      ...
      this.I_StartPlayback = function(e, t) {
        ...
        if (I.extend(d, t), -1 != n) {
          ...
          if (h == R && P.oStreamCapa.bSupportShttpPlay ? (o = W(d.oTransCodeParam) ? P.oProtocolInc.CGI.startShttpPlayback: P.oProtocolInc.CGI.startTransCodePlayback, i = "http://", c = d.iChannelID <= P.iAnalogChannelNum ? d.iChannelID: P.oStreamCapa.iIpChanBase + parseInt(d.iChannelID, 10) - P.iAnalogChannelNum - 1, W(d.iPort) ? "https://" == P.szHttpProtocol ? ( - 1 == P.iHttpPort && (P.iHttpPort = B(P).iHttpPort), a = P.iHttpPort) : a = P.iCGIPort: (P.iHttpPort = d.iPort, a = d.iPort)) : (o = P.oProtocolInc.CGI.startPlayback, i = "rtsp://", c = 100 * d.iChannelID + 1, W(d.iPort) || (P.iRtspPort = d.iPort), -1 == P.iRtspPort && (P.iRtspPort = B(P).iRtspPort), a = P.iRtspPort), -1 == a) return Z("获取端口号失败"),
          r;
          I.extend(d, {
            urlProtocol: i,
            cgi: o,
          ...
          -1 == n && (d.szStartTime = d.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z", d.szEndTime = d.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z", r = P.oProtocolInc.startPlayback(P, d)),
          -1 == r && (P.iRtspPort = -1)
        }
        return r
      },
      this.I_ReversePlayback = function(e, t) {
        ...
        if (I.extend(d, t), -1 != n) {
          ...
          n = this.findWndIndexByIndex(d.iWndIndex),
          -1 == n && (d.szStartTime = d.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z", d.szEndTime = d.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z", r = P.oProtocolInc.reversePlayback(P, d))
        }
      ...
      this.I_Frame = function(e) {
        ...
        if ( - 1 != t) {
          var n = p[t],
          r = n.iPlayStatus; (r == x || r == z) && (s = c.HWP_FrameForward(e), 0 == s && (n.iPlayStatus = z))
        }
        return s
      },
      ...
      this.I_CheckPluginInstall = function() {
        ...
        if (I.browser().msie) try {
          ...
          e = !0
        } catch(t) {} else for (var s = 0,
        n = navigator.mimeTypes.length; n > s; s++) if ("application/hwp-webvideo-plugin" == navigator.mimeTypes[s].type.toLowerCase()) {
          e = !0;
          break
        }
        return e ? 0 : -1
      ...
      et.prototype.processCallback = function(e, t) {
        for (var s = null,
        n = 0; n < this.m_httpRequestSet.length; n++) if (e == this.m_httpRequestSet[n].iRequestID) {
      ...
      st.prototype.ptzAutoControl = function(e, t, s, n) {
        ...
        o = "",
        i = "";
        if (n.iPTZSpeed = n.iPTZSpeed < 7 ? 15 * n.iPTZSpeed: 100, t && (n.iPTZSpeed = 0), e.szDeviceType != X) o = k(this.CGI.ptzAutoControl, e.szHttpProtocol, e.szIP, e.iCGIPort, r),
        i = "<?xml version='1.0' encoding='UTF-8'?><PTZData><pan>" + n.iPTZSpeed + "</pan><tilt>0</tilt></PTZData>";
        else {
          var a = 99;
          t && (a = 96),
      ...
      rt.prototype.extend = function() {
        ...
        s = 1, n = arguments.length; n > s; s++) if (null != (e = arguments[s])) for (var r in e) {
          var o = (t[r], e[r]);
          t !== o && ("object" == typeof o ? t[r] = this.extend({},
          o) : void 0 !== o && (t[r] = o))
        }
        return t
      },
      ...
      rt.prototype.loadXML = function(t) {
        ...
        } else s = new ActiveXObject("Microsoft.XMLDOM"),
        s.async = !1,
        s.loadXML(t);
        return s
      },
      ...
      rt.prototype.Base64 = {
        ...
        encode: function(e) {
          var t, s, n, r, o, i, a, c = "",
          u = 0;
          for (e = rt.prototype.Base64._utf8_encode(e); u < e.length;) t = e.charCodeAt(u++),
          s = e.charCodeAt(u++),
          n = e.charCodeAt(u++),
          r = t >> 2,
          o = (3 & t) << 4 | s >> 4,
        ...
        _utf8_decode: function(e) {
          for (var t = "",
          s = 0,
          n = c1 = c2 = 0; s < e.length;) n = e.charCodeAt(s),
          128 > n ? (t += String.fromCharCode(n), s++) : n > 191 && 224 > n ? (c2 = e.charCodeAt(s + 1), t += String.fromCharCode((31 & n) << 6 | 63 & c2), s += 2) : (c2 = e.charCodeAt(s + 1), c3 = e.charCodeAt(s + 2), t += String.fromCharCode((15 & n) << 12 | (63 & c2) << 6 | 63 & c3), s += 3);
          return t
        }
      },
